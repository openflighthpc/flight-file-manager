# Contributing to flight-file-manager

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to flight-file-manager? Welcome! Please read this
...
You can help flight-file-manager by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-file-manager/issues?state=open)
...
If you find a bug - behaviour of flight-file-manager code or documentation
...
[GitHub issue tracker for flight-file-manager](https://github.com/openflighthpc/flight-file-manager/issues/new)
to report the issue.
...
We want to improve the quality of flight-file-manager and good bug reports are
...
flight-file-manager is Open Source and comes without warranty.
...
flight-file-manager in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of flight-file-manager and really improve it. The more
...
applied to flight-file-manager itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-file-manager). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the flight-file-manager developers also have their regular
